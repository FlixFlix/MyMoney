...
window.locales = {
	...
	/* JSON Seeded information could have different numbers for each country as updates will occur */		
		...
		thin: '35',
		invision: {
			typical: 'AFUUELGMXBC#/392863584_Indonesia_-_Typical_Applicant_-_CrossCore_Results',
			mismatch: 'AFUUELGMXBC#/392880593_Indonesia_-_Mismatched_IDs_-_CrossCore_Results',
			machine: 'AFUUELGMXBC#/392890191_Indonesia_-_Machine_Learning_-_CrossCore_Results',
			fraud: 'AFUUELGMXBC#/392896617_Indonesia_-_Identity_Fraud_Attempt_-_CrossCore_Result',
			thin: 'AFUUELGMXBC#/392899076_Indonesia_-_Thin_File_Attempt_-_CrossCore_Result',
		},
		code: 'ID',
		ISOCode: 'ID',
	/* ID may or may not have backsides,  this variable allows to add or not add picture of backside of ID */			
